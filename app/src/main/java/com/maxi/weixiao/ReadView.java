...
public class ReadView extends TextView {
    ...
    //    Log.d("kk" + TAG, "getCharNum---------num:" + getLayout().getLineEnd(getLineNum()));
    ...
    public int getLineNum() {
     ...
     //   Log.d("kk" + TAG, "getLineNum---------num:" + layout.getLineForVertical(topOfLastLine));
